...
import CaseBackground from './assets/backgrounds/Beco.png';
import CaseBackground2 from './assets/backgrounds/Buraco.png';
...
const RuaSemSaida = ({ onBack }) => {
  ...
  return (
    <div style={{ 
      backgroundImage: `url(${textCompleted ? CaseBackground2 : CaseBackground})`, 
